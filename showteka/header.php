...
<body <?php body_class(); ?>>
  <div id="wrapper">
    ...
    <div class="header-content">
      ...
      <div class="b-phones">
        <div class="b-phone"><strong class="g-fz-20 g-ff-c"><a href="#call-step-1" class="g-a-fake fb-modal">Заказать звонок</a></strong></div>
        <br>
        <div class="b-phones-i g-ff-c">
          <!-- <a href="tel:+7-495-542-1312" class="g-fz-40 phone-number"><span class="code">+7 495 </span>542-13-12</a> -->
        </div>
        <div class="b-phones-i g-ff-c">
          <a href="tel:+7-495-542-1312" class="g-fz-40 phone-number"><span class="code">+7 495 </span>542-13-12</a>
        </div>
      ...
      <div class="header-actions">
        ...
        <div class="action-form">
          <form role="search" action="/s-result/" id="searchform" method="get">
            <input type="text" class="search-action datepicker-u" placeholder="Выберите дату" />
